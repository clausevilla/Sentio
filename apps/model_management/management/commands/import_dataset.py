...
from apps.model_management.models import DataUpload
from apps.model_management.services import import_csv_dataset
...
class Command(BaseCommand):     #Import CSV dataset into DatasetRecord
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Imported {dataset_type} dataset from {file_path}"))