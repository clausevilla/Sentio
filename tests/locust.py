# Simple Load Test for Sentio ML Platform
# Tests: Home, Register, Login, Predict, History, Health
#
# Quick test (1 minute):
#   locust -f locustfile.py --host=http://34.51.186.204 \
#       --users 10 --spawn-rate 5 --run-time 1m --headless --html=report.html
...
class SentioUser(HttpUser):
    ...
    Register -> Login -> Predict -> View History
    """
